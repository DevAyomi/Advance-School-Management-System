                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="content-top-agile p-10">
                            ...
                            <p class="text-white-50">Login As An Admin</p>                          
                        </div>
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-6">
                                     <div class="fog-pwd text-right">
                                        <a href="{{ route('admin.forgot') }}" class="text-white hover-info"><i class="ion ion-locked"></i> Forgot pwd?</a><br>
                                      </div>
                                    </div>
                                    <!-- /.col -->
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">Student? <a href="{{ route('user.login')}}" class="text-danger ml-5">Sign In</a></p>
                            </div>
                        </div>
                    </div>
                </div>
